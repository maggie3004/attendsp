        ...
        {pending.length === 0 ? (
          ...
          pending.map((leave) => (
            <motion.div
              ...
              className="rounded-[1.5rem] border border-slate-200/60 bg-white p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)]"
            >
              ...
              <div className="flex items-center gap-3">
                <button
                  ...
                  className="flex-1 inline-flex items-center justify-center gap-2 rounded-[1rem] border border-emerald-500/20 bg-emerald-50 px-4 py-3 h-11 text-sm font-bold text-emerald-700 hover:bg-emerald-100 transition"
                >
                ...
                <button
                  ...
                  disabled={processingId === leave.id}
                  className="flex-1 inline-flex items-center justify-center gap-2 rounded-[1rem] border border-red-500/20 bg-rose-50 px-4 py-3 h-11 text-sm font-bold text-red-700 hover:bg-rose-100 transition"
                >
